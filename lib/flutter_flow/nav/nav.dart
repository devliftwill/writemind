...
class AppStateNotifier extends ChangeNotifier {
  WritemindFirebaseUser? initialUser;
  WritemindFirebaseUser? user;
  ...
  void update(WritemindFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? StoriesWidget() : OnboaringWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            FFRoute(
              name: 'Onboaring',
              path: 'onboaring',
              builder: (context, params) => OnboaringWidget(),
            ),
            FFRoute(
              name: 'Login',
              path: 'login',
